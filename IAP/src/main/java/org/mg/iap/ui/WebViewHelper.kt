    ...
    fun openWebView(url: String, account: Account?) {
        ...
        webView.webViewClient = object : WebViewClientCompat() {
            override fun onReceivedError(
                ...
                LogUtils.e("Error loading: $error")
            }
...
//                        })
//                    } catch (e: Exception) {
//                        LogUtils.d("Error forwarding to browser", e)
//                    }
//                    return true
//                }
                return false
    ...
    private fun openWebWithAccount(account: Account, url: String) {
        try {
            ...
            LogUtils.d("Opening $authUrl")
            webView.post {
                loadWebViewUrl(authUrl)
            }
        } catch (e: Exception) {
            LogUtils.d("Failed to get weblogin auth.", e)
            activity.finish()
        }
    }
